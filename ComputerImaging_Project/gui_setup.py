...
def setup_frames(root):
    ...
    return top_frame, operation_frame, operation_frame2,input_image_frame, input_image_frame2, output_image_frame, command_frame
...
def setup_command_interface(command_frame, input_image_data, tree_view, root_ID, output_image_label):
    ...
    command_entry.bind(
        "<Return>",
        lambda e: execute_command(e, command_entry, input_image_data, tree_view, root_ID, output_image_label, path_label)
    )
